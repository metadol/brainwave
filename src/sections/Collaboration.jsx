        ...
        <Section crosses>
            <div className='container lg:flex'>
                ...
                <div className='max-w-[25rem] '>
                    ...
                    <ul className='max-w-[22rem] mb-10 md:mb-18 '>
                ...
                <div className='lg:ml-auto xl:w-[38rem] mt-4 hidden sm:block'>
                    <p className='body-2 mb-4 text-n-4 md:mb-16 lg:mb-12 lg:w-[22rem] lg:mx-auto'>
                        {collabText}
                    </p>
